 ...
 */
@property (atomic, assign) BOOL parsesStrictly;
 ...
 */
@property (atomic, assign) BOXISO8601DateFormat format;
/*!
 ...
 */
@property (atomic, assign) BOOL includeTime;
/*!
 ...
 *
 */
@property (atomic, assign) BOOL useMillisecondPrecision;
/*!
 ...
 *	@sa	timeZoneSeparator
 */
@property (atomic, assign) unichar timeSeparator;
/*!
 ...
 *	@sa	timeSeparator
 */
@property (atomic, assign) unichar timeZoneSeparator;
